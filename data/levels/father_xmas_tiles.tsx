...
<tileset version="1.10" tiledversion="1.11.2" name="tiles.png" tilewidth="16" tileheight="16" tilecount="320" columns="20">
 <image source="tiles.png" width="320" height="258"/>
 <tile id="60">
  <animation>
